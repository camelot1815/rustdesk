...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_cert_tip", "Support 인증서 설치"),
        ("confirm_install_cert_tip", "이 인증서는 Support 테스트 인증서이므로 신뢰할 수 있습니다. 인증서는 Support 드라이버를 신뢰하고 설치하는 데 사용됩니다"),
        ("RDP Settings", "RDP 설정"),
        ("Sort by", "정렬 기준"),
        ...
        ("verify_rustdesk_password_tip", "Support 비밀번호 확인"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Support 서버 전문가 버전 {} 으로 업그레이드하세요"),
