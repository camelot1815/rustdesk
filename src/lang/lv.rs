...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "Lai attālināti vadītu savu darbvirsmu, jums ir jāpiešķir Support \"Accessibility\" atļaujas."),
        ("config_screen", "Lai attālināti piekļūtu darbvirsmai, jums ir jāpiešķir Support \"Screen Recording\" atļaujas."),
        ...
        ("android_input_permission_tip1", "Lai attālā ierīce varētu vadīt jūsu Android ierīci, izmantojot peli vai pieskārienu, jums ir jāatļauj Support izmantot servisu \"Accessibility\"."),
        ("android_input_permission_tip2", "Lūdzu, dodieties uz nākamo sistēmas iestatījumu lapu, atrodiet un ievadiet [Installed Services], ieslēdziet servisu [Support Input]."),
        ...
        ("android_open_battery_optimizations_tip", "Ja vēlaties atspējot šo funkciju, lūdzu, dodieties uz nākamo Support lietojumprogrammas iestatījumu lapu, atrodiet un ievadiet [Battery], noņemiet atzīmi no [Unrestricted]"),
        ...
        ("config_input", "Lai vadītu attālo darbvirsmu ar tastatūru, jums ir jāpiešķir Support \"Input Monitoring\" atļaujas."),
        ("config_microphone", "Lai runātu attālināti, jums ir jāpiešķir Support \"Record Audio\" atļaujas."),
        ...
        ("enter_rustdesk_passwd_tip", "Ievadiet Support paroli"),
