...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, Support bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, Support'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için Support'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için Support'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, Support'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [Support Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep Support background service", "Support arka plan hizmetini sürdürün"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için Support'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için Support'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan Support'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("install_cert_tip", "Support sertifikasını yükleyin"),
        ("confirm_install_cert_tip", "Bu, güvenilir olabilecek bir Support test sertifikasıdır. Sertifika, gerekli olduğunda Support sürücülerini güvenilir ve yüklemek üzere kullanacaktır."),
        ...
        ("verify_rustdesk_password_tip", "Support parolasını doğrulayın"),
