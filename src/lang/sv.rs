...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till Support..."),
        ...
        ("install_tip", "På grund av UAC, kan inte Support fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera Support på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge Support \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge Support \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [Support Input] tjänsten."),
        ...
        ("Language", "Språk"),
        ("Keep Support background service", "Behåll Support i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa Support programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
