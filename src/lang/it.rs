...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione a Support 'Registra audio'."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto faccia clic su OK nella finestra UAC dell'esecuzione di Support."),
