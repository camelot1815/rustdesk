...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети Поддержка..."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC приложение Поддержка может работать неправильно на удалённом узле. Чтобы избежать UAC, нажмите кнопку ниже для установки приложения Поддержка в системе."),
        ...
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удалённо управлять своим рабочим столом, вы должны предоставить приложению Поддержка права \"доступа\""),
        ("config_screen", "Для удалённого доступа к рабочему столу вы должны предоставить приложению Поддержка права \"снимок экрана\""),
        ...
        ("Note", "Заметка"),
        ("Connection", "Главная"),
        ("Share Screen", "Соединение"),
        ("Chat", "Чат"),
        ("Total", "Всего"),
        ("items", "элементы"),
        ("Selected", "Выбрано"),
        ("Screen Capture", "Запустить службу"),
        ("Input Control", "Включить проверку"),
        ("Audio Capture", "Захват аудио"),
        ("File Connection", "Файловое подключение"),
        ("Screen Connection", "Подключение Поддержки"),
        ...
        ("android_input_permission_tip1", "Чтобы поддержка могла проверить Ваше устройство, Вы должны предоставить дополнительные разрешения."),
        ("android_input_permission_tip2", "Перейдите на соответствующую страницу системных настроек, найдите и войдите в \"Установленные службы\", включите службу \"Поддержка\"."),
        ("android_new_connection_tip", "Получен новый запрос на подключение системы безопастности."),
        ("android_service_will_start_tip", "Включение службы поддержки, позволяет системе зарегистрировать Ваше устройство."),
        ...
        ("android_start_service_tip", "Нажмите [Запустить службу], чтобы запустить службу Поддержки."),
        ...
        ("Language", "Язык"),
        ("Keep Support background service", "Держать в фоне службу Поддержки"),
        ...
        ("Start the screen sharing service on boot, requires special permissions", "Требуются специальные разрешения"),
        ...
        ("Show Support", "Показать Поддержка"),
        ...
        ("config_input", "Чтобы управлять удалённым рабочим столом с помощью клавиатуры, необходимо предоставить приложению Поддержка разрешения \"Мониторинг ввода\"."),
        ("config_microphone", "Чтобы разговаривать с удалённой стороной, необходимо предоставить приложению Поддержка разрешение \"Запись аудио\"."),
        ...
        ("still_click_uac_tip", "По-прежнему требуется, чтобы удалённый пользователь нажал \"OK\" в окне UAC при запуске приложения Поддержка."),
        ...
        ("install_cert_tip", "Установить сертификат Поддержка"),
        ("confirm_install_cert_tip", "Это тестовый сертификат Поддержка, которому можно доверять. Он будет использоваться только по необходимости для установки драйверов Поддержка."),
        ...
        ("verify_rustdesk_password_tip", "Подтвердить пароль Поддержка"),
        ...
        ("scam_text1", "Если вы разговариваете по телефону с кем-то, кого вы НЕ ЗНАЕТЕ и НЕ ДОВЕРЯЕТЕ, и он просит вас использовать приложение Поддержка и запустить его службу, не продолжайте и немедленно прервите разговор."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Обновите приложение Поддержка Про до версии {} или новее!"),
        ...
        ("selinux_tip", "На вашем устройстве включён SELinux, что может помешать правильной работе приложения Поддержка на контролируемой стороне."),
        ("Change view", "Вид"),
