...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_service_will_start_tip", "Включение захвата экрана автоматически запускает службу, позволяя системе зарегистрировать ваше устройство."),
        ...
        ("android_start_service_tip", "Нажмите [Запустить службу], чтобы запустить службу демонстрации экрана."),
