...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі Підтримка..."),
        ...
        ("install_tip", "Через UAC в деяких випадках додаток Підтримка може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення Підтримка в системі"),
        ...
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати додатку Підтримка дозволи \"Доступності\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці,вам необхідно надати додатку Підтримка дозволи на \"Запис екрану\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або торкання, вам необхідно дозволити Підтримка використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [Підтримка]."),
        ...
        ("Language", "Мова"),
        ("Keep Support background service", "Зберегти фонову службу Підтримка"),
        ...
        ("Show Support", "Показати Підтримка"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_input", "Для віддаленого керування віддаленою стільницею з клавіатури, вам необхідно надати додатку Підтримка дозволи на \"Відстеження введення\""),
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати додатку Підтримка дозвіл на \"Запис аудіо\""),
        ...
        ("install_cert_tip", "Додати сертифікат Підтримка"),
        ("confirm_install_cert_tip", "Це сертифікат тестування Підтримка, якому можна довіряти. За потреби сертифікат буде використано для погодження та встановлення драйверів Підтримка."),
        ...
        ("verify_rustdesk_password_tip", "Перевірте пароль Підтримка"),
        ...
        ("scam_text1", "Якщо ви розмовляєте по телефону з кимось, кого НЕ ЗНАЄТЕ чи кому НЕ ДОВІРЯЄТЕ, і ця особа хоче, щоб ви використали Підтримка та запустили службу, не робіть цього та негайно завершіть дзвінок."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Будь ласка, оновіть Підтримка Про до версії {} чи новіше!"),
        ...
        ("selinux_tip", "SELinux увімкнено на вашому пристрої, що може ускладнити для іншої сторони віддалене керування за допомогою додатка Підтримка."),
