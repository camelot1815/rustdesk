...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "Om je bureaublad op afstand te kunnen bedienen, moet je Support \"toegankelijkheid\" toestemming geven."),
        ("config_screen", "Om toegang te krijgen tot het externe bureaublad, moet je Support de toestemming \"schermregistratie\" geven."),
        ...
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geinstalleerde Services], schakel de service [Support Input] in."),
