...
import support.MessageOuterClass.KeyboardMode
import support.MessageOuterClass.ControlKey

object KeyEventConverter {
    fun toAndroidKeyEvent(keyEventProto: support.MessageOuterClass.KeyEvent): KeyEvent {
        var chrValue = 0
        var modifiers = 0
    ...
    private fun convertModifier(controlKey: support.MessageOuterClass.ControlKey): Int {
    ...
    private fun convertControlKeyToKeyCode(controlKey: support.MessageOuterClass.ControlKey): Int {
        // Add logic to map ControlKey values to Android KeyEvent key codes.
        // You'll need to provide the mapping for each key.
        return when (controlKey) {
