...
lazy_static::lazy_static! {
    pub static ref ORG: Arc<RwLock<String>> = Arc::new(RwLock::new("com.support".to_owned()));
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: Arc<RwLock<String>> = Arc::new(RwLock::new("Support".to_owned()));
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["94.142.137.241"];
